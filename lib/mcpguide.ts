...
| Tune your agent from real interaction | \`tune_agent\` | \`{ "teamCode": "PRSM-TEAM-…", "agentId": "…", "worked": ["terse-bullets"], "adjust": ["less-hedging"] }\` — behavioral only; folds into your learned overlay |
